...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/checks-807-orange.svg" alt="Checks">
...
**HARDAX** (Hardening Audit eXaminer) is a comprehensive security configuration auditor for Android-based devices. It performs **807 security checks** across **29 categories** to identify misconfigurations, vulnerabilities, and security weaknesses.
...
| Feature | Description |
|---------|-------------|
| **807 Security Checks** | Comprehensive coverage across 29 security categories |
...
HARDAX organizes **807 checks** into **29 security categories**:
...
| **NETWORK** | 76 | Ports, WiFi, cellular (incl. Allow 2G), VPN, MQTT, CoAP, CAN bus, HL7, DICOM, hotspot WPA mode, active connections, eSIM/eUICC provisioning, IPv4/IPv6 network hardening sysctls (ICMP redirects, source routing, SYN cookies, RA acceptance) |
...
└── hardax/                # The installable Python package
    ...
    └── commands/          # Security check definitions (807 checks, 29 categories)
